let Koa,Router,bodyParser,mongoose,api,jwtMiddleware;_132‍.w("koa",[["default",["Koa"],function(v){Koa=v}]]);_132‍.w("koa-router",[["default",["Router"],function(v){Router=v}]]);_132‍.w("koa-bodyparser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_132‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_132‍.w("./api",[["default",["api"],function(v){api=v}]]);_132‍.w("./lib/jwtMiddleware",[["default",["jwtMiddleware"],function(v){jwtMiddleware=v}]]);// 실행 yarn start:dev (수정하면 자동 리로드)
...
app.listen(port, () => {
    _132‍.g.console.log('%d 포트 시작', port);
});